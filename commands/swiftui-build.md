...
1. `.claude/shared/swiftui-build.md` — headless runs (installed into the clone)
2. `${CLAUDE_PLUGIN_ROOT}/shared/swiftui-build.md` — installed as a plugin
3. `shared/swiftui-build.md` — working inside the agent-skills checkout
