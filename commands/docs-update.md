...
1. `.claude/shared/docs-update.md` — headless runs (installed into the clone)
2. `${CLAUDE_PLUGIN_ROOT}/shared/docs-update.md` — installed as a plugin
3. `shared/docs-update.md` — working inside the agent-skills checkout
